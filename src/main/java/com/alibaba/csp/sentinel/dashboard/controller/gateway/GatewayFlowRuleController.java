...
import com.alibaba.csp.sentinel.dashboard.redis.InRedisGatewayFlowRuleStore;
...
public class GatewayFlowRuleController {
    ...
    // 将原来的 流控规则存储服务更换为 自定义的 基于Redis 的
    @Autowired
    // private InMemGatewayFlowRuleStore repository;
    private InRedisGatewayFlowRuleStore repository;
